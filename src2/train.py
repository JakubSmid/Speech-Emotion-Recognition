...
class DataGenerator(Sequence):
    def __init__(self, files, batch_size, encoder, input_shape=(128, 156), shuffle=True):
        self.files = files
...
model.add(Conv2D(16, (3, 3), input_shape=(128, 156, 1), activation='relu', padding="same"))
...
history = model.fit(train_gen, validation_data=test_gen, epochs=60, class_weight=class_weights)
